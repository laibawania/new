...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 - <?php echo $_SESSION['setting_name'] ?> | <a href="http://localhost:1337/hrm/login" target="_blank">Esolech Tech</a></div></div>
        </footer>
