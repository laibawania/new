...
<div class="container-fluid">
  ...
  <div class="dropdown-menu" aria-labelledby="statusDropdown">
    <button class="dropdown-item filter_status btn-primary" type="button" data-id="all">All</button>
    <?php foreach ($stat_arr as $key => $value): ?>
      <button class="dropdown-item filter_status btn-<?php echo $key == 0 ? 'primary' : 'info' ?>" type="button" data-id="<?php echo $key ?>"><?php echo $value ?></button>
    <?php endforeach; ?>
  </div>
</div>
					</div>
