...
<!---
       ...
       <?php if($this->session->userdata('isLogIn')): ?>
        ...
        <li class="treeview <?php echo (($this->uri->segment(2)=="recruitment")?"active":null) ?>">
            <a href="#"><i class="pe-7s-mail"></i>
               <span><?php echo display('recruitment')?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
            <li><a href="http://localhost:1337/recruitment/admin/index.php?page=home" target="_blank">vacancy</a></li>
